...
| `pickerOptions`   | `picker-options`    | Any additional options that the picker interface can accept. See the [Picker API docs](../picker) for the picker options.                                                                                                                                                                                                                                                                                                                                                                         | `any`                                       | `undefined`     |
...
| `ionChange` | Emitted when the value (selected date) has changed. | `CustomEvent<any>`  |
